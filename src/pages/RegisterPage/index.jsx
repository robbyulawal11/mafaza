        ...
        <div className="container flex justify-center mt-[30px] mb-[123px]">
            ...
            <CardContent>
                ...
                <div className="grid w-full items-center justify-center gap-4 mb-[20px]">
                    ...
                    <Label  className='text-[#062126] opacity-70 font-medium text-[16px]' htmlFor="name">Nama</Label>
                    <Input className='w-[400px] bg-white' type='text' id="name" placeholder="" />
                    </div>
                    <div className="flex flex-col space-y-1.5">
                    <Label className='text-[#062126] opacity-70 font-medium text-[16px]' htmlFor="email">Email</Label>
                    ...
                    <div className="flex flex-col space-y-1.5">
                    <Label className='text-[#062126] opacity-70 font-medium text-[16px]' htmlFor="password">Password</Label>
                    ...
                    <div className="flex flex-col space-y-1.5">
                    <Label className='text-[#062126] opacity-70 font-medium text-[16px]' htmlFor="passwordConfirm">Password Confirm</Label>
                    <Input className='w-[400px] bg-white' type='password' id="passwordConfirm" placeholder="" />
                    </div>
                </div>
                <div className="flex flex-col justify-center items-center">
                    <Button className='w-[400px] text-[20px] font-semibold mb-[18px] hover:bg-[#0F97B5]'  type='submit'>Register</Button>
            ...
            <CardFooter className="flex flex-col w-full">
                <div className="flex justify-end w-[400px] mb-[16px]">
                    <a href="/login" className="text-[#062126] opacity-70 font-medium text-[16px] cursor-pointer hover:underline decoration-solid">You have an account?</a>
                </div>
                <Link to={'/login'}>
                    <Button className='w-[400px] text-[#24BEE0] border-[#24BEE0] bg-white text-[20px] font-semibold hover:border-[#0F97B5] hover:text-[#0F97B5]' variant="outline">Login</Button>
                </Link>
            </CardFooter>
            </Card>
        </div>
