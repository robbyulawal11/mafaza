        ...
        <div className="container flex justify-center mt-[30px] mb-[123px]">
            ...
            <CardContent>
                <form onSubmit={onHandleLogin} className="flex flex-col items-center">
                    ...
                    <Button className='w-[400px] text-[20px] font-semibold mb-[18px] hover:bg-[#0F97B5]' type='submit'>Login</Button>
                    {error && <p className="text-red-500 text-[16px] font-regular">{errorMessage}</p>}
                </form>
            </CardContent>
            <CardFooter className="flex flex-col w-full">
                <div className="flex justify-end w-[400px] mb-[16px]">
                    <a href="/register" className="text-[#062126] opacity-70 font-medium text-[16px] cursor-pointer hover:underline decoration-solid">Dont have an account?</a>
                </div>
                <Link to={'/register'}>
                    <Button className='w-[400px] text-[#24BEE0] border-[#24BEE0] bg-white text-[20px] font-semibold hover:border-[#0F97B5] hover:text-[#0F97B5]' variant="outline">Register</Button>
                </Link>
            </CardFooter>
            </Card>
        </div>
