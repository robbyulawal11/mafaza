...
export function InputForm() {
    ...
    const onHandleSend = (userAppointment) => {
        axios.post(`${import.meta.env.VITE_ENDPOINT}/appointment`, JSON.stringify(userAppointment), {
          headers: {
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="container w-2/3 space-y-6">
                        ...
                        render={({ field }) => (
                            ...
                            <FormControl>
                                ...
                                className="resize-none w-[776px] h-[150px] bg-white rounded-[10px]"
                                {...field}
                                />
                            </FormControl>
                            <FormMessage />
                        ...
                        <div className="flex gap-x-[32px] mb-[30px] justify-center">
                            <Button className='w-[156px] h-[67px] hover:bg-[#0F97B5]'  type="submit">Send <img className="ml-[20px]" src={send} alt="send" /></Button>
                        </div>
                    </form>
                </Form>
            </div>
